...
const localizedSceneDetails: Record<string, Record<string, LocalizedSceneDetails>> = {
  ...
  ar: {
    'home-cinema': { description: 'أنشئ سينما منزلية متكاملة بجهاز العرض والشاشة والحامل والملحقات المناسبة للغرفة.', considerations: ['إضاءة الغرفة ومادة الشاشة', 'مسافة المشاهدة وحجم الصورة', 'نسبة الإسقاط وموضع التركيب'] },
    'living-room-laser-tv': { description: 'أنظمة عرض ذات إسقاط فائق القصر لغرف المعيشة المضيئة وتركيبات نظيفة مدمجة مع الأثاث.', considerations: ['توافق جهاز UST مع شاشة CLR', 'عمق الخزانة والتهوية', 'أداء السطوع في ضوء النهار'] },
    'bedroom-small-space': { description: 'خيارات عرض مدمجة وهادئة لغرف النوم والشقق والمساحات الصغيرة المرنة.', considerations: ['مسافة مشاهدة قصيرة', 'تشغيل منخفض الضوضاء', 'تركيب محمول أو مدمج'] },
    'gaming-room': { description: 'أنظمة ألعاب على شاشة كبيرة مختارة وفق تأخر الإدخال ومعدل التحديث والتوافق مع أجهزة الألعاب.', considerations: ['تأخر الإدخال ومعدل التحديث', 'التوافق مع HDMI وأجهزة الألعاب', 'التحكم في الإضاءة المحيطة'] },
    'outdoor-cinema': { description: 'مجموعات محمولة من جهاز العرض والشاشة للحدائق والتخييم والفعاليات الخارجية المؤقتة.', considerations: ['طاقة محمولة وخيارات الاتصال', 'تخزين محمي من الطقس', 'إعداد سريع للشاشة'] },
    'meeting-rooms': { description: 'أنظمة موثوقة للعروض التقديمية والتعاون لغرف الاجتماعات الصغيرة ومجالس الإدارة والمؤتمرات.', considerations: ['سعة الغرفة وحجم الشاشة', 'سير عمل العرض اللاسلكي', 'التركيب ومسارات الكابلات'] },
    'education-training': { description: 'حزم عرض منخفضة الصيانة للفصول ومراكز التدريب وعمليات النشر في عدة غرف.', considerations: ['السطوع تحت إضاءة الفصل', 'الصيانة المركزية', 'تسعير الكميات والوحدات الاحتياطية'] },
    'hotels-hospitality': { description: 'حلول لغرف الضيوف والصالات والاجتماعات والترفيه مع تسعير المشاريع ودعم التركيب.', considerations: ['تجربة الضيف وسهولة التحكم', 'الدمج مع الأثاث', 'اتساق النشر في عدة مواقع'] },
    'bars-restaurants': { description: 'أنظمة شاشات كبيرة مؤثرة لمشاهدة الرياضة والغرف الخاصة ومساحات الترفيه ذات العلامة.', considerations: ['سطوع مناسب للإضاءة المحيطة القوية', 'تخطيطات متعددة الشاشات', 'ساعات تشغيل يومية طويلة'] },
    'retail-showrooms': { description: 'أنظمة عرض بصري مرنة لإطلاق المنتجات والعروض والمحتوى الغامر.', considerations: ['تنسيق المحتوى وسطح العرض', 'جدول التشغيل', 'تركيب مخفي وتقديم العلامة'] },
    'events-rental': { description: 'حزم سهلة النقل والصيانة للمؤتمرات والمعارض وأساطيل التأجير.', considerations: ['تركيب وفك سريعان', 'صناديق نقل وقطع غيار', 'إضاءة المكان ومسافة الإسقاط'] },
    'large-venues': { description: 'حلول تركيب عالية السطوع للقاعات ودور العبادة والصالات والمساحات العامة الكبيرة.', considerations: ['مسافة الإسقاط واختيار العدسة', 'هياكل التعليق والسلامة', 'الأنظمة الاحتياطية وسهولة الوصول للصيانة'] },
  },
};
...
const categoryLabels: Record<string, Record<string, string>> = {
  ...
  ar: {
    'home-smart-projectors': 'أجهزة عرض ذكية للمنزل',
    'high-end-home-theater-projectors': 'أجهزة عرض سينما منزلية متقدمة',
    'projection-screens': 'شاشات عرض',
    'ust-laser-tv': 'تلفزيونات ليزر بإسقاط فائق القصر',
    'alr-clr-screens': 'شاشات ALR / CLR',
    'av-furniture': 'أثاث صوتي ومرئي',
    'portable-mini-projectors': 'أجهزة عرض محمولة وصغيرة',
    'desktop-stands': 'حوامل مكتبية',
    'portable-outdoor-screens': 'شاشات محمولة وخارجية',
    'cases-bags': 'حقائب وصناديق',
    'business-education-projectors': 'أجهزة عرض للأعمال والتعليم',
    'motorized-screens': 'شاشات مزودة بمحرك',
    'ceiling-mounts': 'حوامل سقفية',
    'solution-bundles': 'حزم حلول',
    'engineering-projectors': 'أجهزة عرض للتركيبات الاحترافية',
    'projector-mounts-stands': 'حوامل وقواعد أجهزة العرض',
    'accessories-parts': 'ملحقات وقطع غيار',
    'fixed-frame-screens': 'شاشات بإطار ثابت',
  },
};
