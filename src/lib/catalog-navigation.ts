export const productNavigation = [
  {
    ...
    children: [
      ...
      ['UST / Laser TV', 'ust-laser-tv'],
      ['Portable Projectors', 'portable-projectors'],
      ['Business & Education', 'business-education-projectors'],
      ['Installation Projectors', 'installation-projectors'],
      ['4K Laser Projectors', '4k-laser-projectors'],
    ],
  },
  {
...
export const sceneDetails: Record<string, {
  ...
  'home-cinema': {
    ...
    categorySlugs: ['home-theater-projectors', '4k-laser-projectors', 'projection-screens'],
  },
  ...
  'bedroom-small-space': {
    ...
    categorySlugs: ['portable-projectors', 'desktop-stands', 'portable-outdoor-screens'],
  },
  'gaming-room': {
    ...
    categorySlugs: ['home-theater-projectors', 'projection-screens'],
  },
  'outdoor-cinema': {
    ...
    categorySlugs: ['portable-projectors', 'portable-outdoor-screens', 'cases-bags'],
  },
  'meeting-rooms': {
  ...
  'bars-restaurants': {
    ...
    categorySlugs: ['installation-projectors', 'alr-clr-screens', 'projector-mounts-stands'],
  },
  'retail-showrooms': {
    ...
    categorySlugs: ['installation-projectors', 'projector-mounts-stands', 'accessories-parts'],
  },
  'events-rental': {
    ...
    categorySlugs: ['installation-projectors', 'portable-outdoor-screens', 'cases-bags'],
  },
  'large-venues': {
    ...
    categorySlugs: ['installation-projectors', 'fixed-frame-screens', 'ceiling-mounts'],
  },
};
