...
export const metadata: Metadata = {
  ...
  description: 'Request wholesale pricing and international shipping options for projectors, screens, mounts, and installation accessories. DDP is available for selected destinations.',
};
...
export default function WholesalePage() {
  ...
  const advantages = [
    ...
    { icon: '🚢', title: 'Flexible Shipping Terms', desc: 'DDP is available for selected destinations; DAP and project freight are quoted when more suitable.' },
  ...
  const steps = [
    ...
    { step: 4, title: 'We Arrange Delivery', desc: 'We confirm the route, shipping cost, trade term, and estimated transit time before dispatch.' },
  ];
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 sm:text-xl">Partner with REACH PROJECTOR for project pricing, destination-specific shipping terms, and dedicated support.</p>
