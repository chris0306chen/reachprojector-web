...
export const metadata: Metadata = {
  title: 'B2B Projector Wholesale | OEM/ODM & Global Sourcing | REACH PROJECTOR',
  description: 'Request wholesale pricing for projectors, projection screens and mounts. Global sourcing, dedicated account management and OEM/ODM support for business buyers.',
};
    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">Projector Sourcing, <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Simplified.</span></h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 sm:text-xl">Partner with REACH PROJECTOR for projector, screen and mount sourcing, wholesale pricing, and dedicated support for your business.</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <a href="/products?category=projector-mounts" className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-700 p-8 text-white shadow-lg transition hover:shadow-xl">
              <div className="relative z-10">
                <h3 className="text-2xl font-bold">Projector Mounts</h3>
                <p className="mt-2 text-gray-300">Ceiling, wall and floor mounting solutions for professional projection installations.</p>
                <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-cyan-300 group-hover:gap-2 transition-all">Browse Mounts<svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></span>
              </div>
              <div className="absolute -right-6 -bottom-6 h-40 w-40 rounded-full bg-white/10" />
            </a>
          </div>
