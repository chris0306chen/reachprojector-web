...
export const metadata: Metadata = {
  ...
  description:
    'Get exclusive wholesale pricing on 4K laser projectors, printers, and computer components. DDP shipping, dedicated account managers, and flexible OEM/ODM solutions for business buyers worldwide.',
};
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
            Bulk Electronics Sourcing,{' '}
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
              Simplified.
            </span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 sm:text-xl">
            Partner with REACH PROJECTOR for competitive wholesale pricing, global DDP
            shipping, and dedicated support — everything your business needs to scale.
          </p>
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              href="#rfq-form"
              className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-blue-600/30 transition hover:bg-blue-700"
            >
              Request Bulk Quote
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border-2 border-green-500 px-8 py-3.5 text-base font-semibold text-green-400 transition hover:bg-green-500/10"
            >
      ...
      <section className="bg-gray-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-gray-500">
            We go beyond wholesale — we build long-term partnerships that help your business grow.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { step: 3, title: 'Confirm & Pay', desc: 'Approve the quote and complete payment securely.' },
              ...
              <div key={s.step} className="relative text-center">
                ...
                {s.step < 4 && (
                  <div className="absolute top-6 left-1/2 hidden h-0.5 w-full bg-blue-200 lg:block" />
                )}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <a
              ...
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-900 to-blue-700 p-8 text-white shadow-lg transition hover:shadow-xl"
            >
              <div className="relative z-10">
                <h3 className="text-2xl font-bold">4K Laser Projectors</h3>
                <p className="mt-2 text-blue-200">
                  Ultra-bright, long-lasting laser projectors for home theater, business, and education.
                </p>
                <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-cyan-300 group-hover:gap-2 transition-all">
                  Browse Projectors
            ...
            <a
              href="/products?category=printers-scanners"
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-700 p-8 text-white shadow-lg transition hover:shadow-xl"
            >
              <div className="relative z-10">
                <h3 className="text-2xl font-bold">Printers & Scanners</h3>
                <p className="mt-2 text-gray-300">
                  Reliable office printers and high-speed scanners for every business environment.
                </p>
                <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-cyan-300 group-hover:gap-2 transition-all">
                  Browse Printers
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="mt-4 text-gray-300">
              Fill in the form below and our wholesale team will get back to you within 24 hours
              with custom pricing.
            </p>
          </div>
          <div className="mt-10">
