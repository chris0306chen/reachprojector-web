...
export const products = pgTable(
	"products",
	{
		...
		meta_description: varchar("meta_description", { length: 170 }),
		import_data: jsonb("import_data").$type<Record<string, unknown>>(),
		product_length_cm: numeric("product_length_cm", { precision: 10, scale: 2 }),
		product_width_cm: numeric("product_width_cm", { precision: 10, scale: 2 }),
		product_height_cm: numeric("product_height_cm", { precision: 10, scale: 2 }),
		net_weight_kg: numeric("net_weight_kg", { precision: 10, scale: 2 }),
		packed_weight_kg: numeric("packed_weight_kg", { precision: 10, scale: 2 }),
		package_length_cm: numeric("package_length_cm", { precision: 10, scale: 2 }),
		package_width_cm: numeric("package_width_cm", { precision: 10, scale: 2 }),
		package_height_cm: numeric("package_height_cm", { precision: 10, scale: 2 }),
		shipping_class: varchar("shipping_class", { length: 20 }).default("parcel").notNull(),
		package_count: integer("package_count").default(1).notNull(),
...
export const inquiries = pgTable(
	"inquiries",
	{
		...
		inventory_restocked: boolean("inventory_restocked").default(false).notNull(),
		created_at: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
		updated_at: timestamp("updated_at", { withTimezone: true }),
	},
	(table) => [
